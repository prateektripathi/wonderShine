  ...
  const carServices = [
    {
      ...
      features: [
        ...
        "Wipe dry",
        "🧼 Windscreen Cleaning Tablet (1 unit)",
        "💨 Car Perfume (mini vial)",
      ],
      price: "₹500 / ₹600 / ₹700",
    ...
    },
    {
      ...
      features: [
        "Interior vacuum with door trims (pockets & panels)",
        "Footmat cleaning (pressure wash if possible)",
        "Seat & boot vacuum cleaning",
        "Exterior pressure foam wash",
        "Tyre & wheel arc pressure wash + polish",
        "Glass cleaning",
        "🎁 Car Perfume (standard)",
        "🧻 Tissue Box",
        "🩰 Cotton Foot Mats (basic)",
      ],
    ...
    },
    {
      ...
      features: [
        "Interior vacuum (door trims, pockets & panels)",
        "Footmat cleaning (pressure wash if possible)",
        ...
        "💎 Car Perfume (premium)",
        "🗑 Mini Dustbin + 🧻 Tissue Box",
        "🌿 Mouth Freshener (mint jar)",
        "🩰 Cotton Foot Mats (premium)",
      ],
